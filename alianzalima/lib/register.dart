    ...
    return Container(
      ...
      child: TextFormField(
        decoration: InputDecoration(
          ...
          labelText: S.of(context).textInputEmail,
  ...
  Widget build(BuildContext context) {
    ...
    final usuario = TextField(
        ...
        decoration: InputDecoration(
          ...
          hintText: S.of(context).textInputUser,
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(12.0)),
        ));
    // email Field
    ...
    final password = TextField(
      decoration: InputDecoration(
        icon: Icon(Icons.lock_open_rounded,
            ...
            color: IconTheme.of(context).color),
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(12.0)),
        hintText: S.of(context).textInputPassword,
      ),
      autofocus: false,
      obscureText: true,
    );
    ...
    final confirmPassword = TextField(
      decoration: InputDecoration(
        icon: Icon(Icons.lock_open_rounded,
            ...
            color: IconTheme.of(context).color),
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(12.0)),
        hintText: S.of(context).textInputConfirmPassword,
      ),
      autofocus: false,
      obscureText: true,
    );
          ...
          return showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                ...
                content: Text(S.of(context).textConfirmSingup),
              );
            },
          );
        },
        child: Text(S.of(context).textRegister,
